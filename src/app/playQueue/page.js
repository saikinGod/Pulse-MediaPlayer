...
import { ListMusic, Search, ArrowUpDown } from "lucide-react";

export default function PlayQueue() {
    const [searchQuery, setSearchQuery] = useState("");

    // Empty state - no queue yet
    const queue = [];
        ...
        <div className="flex flex-col h-full" style={{ background: "#0a0a0f", color: "#e2e0e8" }}>
            ...
            <div className="shrink-0 px-6 pt-6 pb-6">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white">Play Queue</h1>
                        <p className="text-gray-500 text-sm">{queue.length} tracks in queue</p>
                    </div>
                </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6">
                ...
                <h2 className="text-2xl font-semibold text-white mb-2">No queue yet</h2>
                <p className="text-gray-500">Add tracks to start building your queue</p>
            </div>
